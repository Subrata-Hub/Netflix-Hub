...
const ExplorePage = () => {
  ...
  const [showOptions, setShowOptions] = useState([false, false, false]); // Initial state for 3 filter cards
    ...
    <div className="bg-slate-950 overflow-hidden">
      ...
      <div className=" min-h-[700px] flex mx-10 md:mx-12  md:gap-4">
        <div className={`flex flex-col md:w-[20%]`}>
          ...
          >
            {/* filter card 1 */}
            <div className="flex-col w-full py-3  bg-slate-800 rounded-md px-3 border-b border-gray-600">
              <div
              ...
              {showOptions[0] && (
                <>
                  ...
                  <div className="text-white">
                    <h1 className="py-2 text-sm font-light">Sort By Genres</h1>
                    <select
                      className="py-2 text-white bg-slate-500 rounded-lg w-full"
