...
//   return (
//     <div
//       className={`absolute w-screen px-1 md:px-2 md:pl-12 py-0 bg-gradient-to-b from-black z-20 flex justify-between items-center md:justify-between md:items-center`}
//     >
//       <IoMdMenu
...
//         <img
//           className="w-40 md:w-60 flex-col items-center "
//           src={LOGO}
//           alt="logo"
//         />
//         {mobileMenu && (
//           <div className="">
//             <ul className={`text-white hidden md:flex  gap-6 text-lg`}>
//               {showGptSearch ? (
...
//             )} */}
//             <div className="pt-3">
//               <div className="hidden md:flex h-10 py-4 px-5  bg-slate-700 rounded-2xl items-center shadow-lg w-[410px]">
//                 <input
...
//               </div>
//             </div>
//             <IoIosSearch className="font-bold text-2xl text-white cursor-pointer md:hidden" />
